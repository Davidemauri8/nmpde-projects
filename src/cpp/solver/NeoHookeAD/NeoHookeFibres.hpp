#ifndef HEART_NEO_HOOKE_HPP
#define HEART_NEO_HOOKE_HPP
...
class NeoHookeSolver {
public:
  // Physical dimension (1D, 2D, 3D)
  static constexpr unsigned int dim = 3;

  NeoHookeSolver(const unsigned int r_)
...
protected:
  ...
  //----NeoHooke's parameters----
  // Pressure for Neumann
  const ADNumber p_v = 15;
  // Material parameters
  const ADNumber mu = 60;
  const ADNumber lambda = 70;
  // Active pressure term
  const ADNumber T_a = 60;
  //--------------------------
